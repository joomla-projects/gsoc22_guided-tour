...
INSERT INTO `#__guidedtour_steps` (`id`, `tour_id`, `title`, `published`, `description`, `ordering`, `step-no`, `position`, `target`, `redirection`, `interactive`, `url`, `created`, `created_by`, `modified`, `modified_by`) VALUES
...
(6, 1, 'Save and Close', 1, '<p>Save and close the tour.</p>', 0, 1, 'bottom', '#save-group-children-save', 1, 1, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(7, 1, 'Create steps for your Tour', 1, '<p>Click on steps icon in the right.</p>', 0, 1, 'right', '.btn-info', 1, 1, 'administrator/index.php?option=com_guidedtours&view=tours', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(8, 1, 'Click here!', 1, '<p>Click here to create a new Step for your Tour.</p>', 0, 1, 'bottom', '.button-new', 1, 1, 'administrator/index.php?option=com_guidedtours&view=steps&tour_id=1', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(9, 1, 'Add title for your Tour.', 1, '<p>Here you have to add the title of your Tour Step. </p>', 0, 1, 'bottom', '#jform_title', 1, 1, 'administrator/index.php?option=com_guidedtours&view=step&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(10, 1, 'Add Content', 1, '<p>Add the content of your Tour here!</p>', 0, 1, 'bottom', '#details', 1, 1, 'administrator/index.php?option=com_guidedtours&view=step&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
...
(14, 1, 'Save and Close', 1, '<p>Save and close the step.</p>', 0, 1, 'bottom', '#save-group-children-save', 1, 1, 'administrator/index.php?option=com_guidedtours&view=step&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
