...
class GuidedtoursComponent extends MVCComponent implements BootableExtensionInterface
{
    ...
    public const STEP_TYPE_NAMES = [
        self::STEP_NEXT   => 'COM_GUIDEDTOURS_FIELD_VALUE_NEXT_STEP',
        self::STEP_REDIRECT => 'COM_GUIDEDTOURS_FIELD_VALUE_REDIRECT',
        self::STEP_INTERACTIVE    => 'COM_GUIDEDTOURS_FIELD_VALUE_INTERACTIVE_STEP',
    ];
