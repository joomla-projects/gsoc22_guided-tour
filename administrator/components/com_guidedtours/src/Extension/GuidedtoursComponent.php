...
class GuidedtoursComponent extends MVCComponent implements BootableExtensionInterface
{
    ...
    public const STEP_TYPE_NAMES = [
        self::STEP_NEXT        => 'COM_GUIDEDTOURS_FIELD_VALUE_STEP_NEXT',
        self::STEP_REDIRECT    => 'COM_GUIDEDTOURS_FIELD_VALUE_STEP_REDIRECT',
        self::STEP_INTERACTIVE => 'COM_GUIDEDTOURS_FIELD_VALUE_STEP_INTERACTIVE',
    ];
    ...
    public const STEP_INTERACTIVETYPE_NAMES = [
        self::STEP_INTERACTIVETYPE_FORM_SUBMIT => 'COM_GUIDEDTOURS_TYPE_INTERACTIVE_STEP_FORM_SUBMIT_LABEL',
        self::STEP_INTERACTIVETYPE_TEXT        => 'COM_GUIDEDTOURS_TYPE_INTERACTIVE_STEP_TEXT_FIELD_LABEL',
        self::STEP_INTERACTIVETYPE_BUTTON      => 'COM_GUIDEDTOURS_TYPE_INTERACTIVE_STEP_BUTTON_LABEL',
        self::STEP_INTERACTIVETYPE_OTHER       => 'COM_GUIDEDTOURS_TYPE_INTERACTIVE_STEP_OTHER_LABEL',
    ];

    /**
     * An interactive step where a user click on a form button.
     *
     * @since __DEPLOY_VERSION__
     */
