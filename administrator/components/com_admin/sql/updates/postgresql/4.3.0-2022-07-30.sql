...
(2, 0, 'How to create Articles?', '<p>This Tour will show you how you can create Articles in Joomla!</p>', 0, '[\"*\"]', 'administrator/index.php?option=com_content&view=articles', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0, NULL, 0, 1),
(3, 0, 'How to create Categories?', '<p>This Tour will show you how you can create Categories in Joomla!</p>', 0, '[\"*\"]', 'administrator/index.php?option=com_categories&view=categories&extension=com_content', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0, NULL, 0, 1),
(4, 0, 'How to create Menus?', '<p>This Tour will show you how you can create Menus in Joomla!</p>', 0, '[\"*\"]', 'administrator/index.php?option=com_menus&view=menus', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0, NULL, 0, 1),
(5, 0, 'How to create Tags?', '<p>This Tour will show you how you can create Tags in Joomla!</p>', 0, '[\"*\"]', 'administrator/index.php?option=com_tags&view=tags', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0, NULL, 0, 1),
(6, 0, 'How to create Banners?', '<p>This Tour will show you how you can create Banners in Joomla!</p>', 0, '[\"*\"]', 'administrator/index.php?option=com_banners&view=banners', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0, NULL, 0, 1),
(7, 0, 'How to create Contacts?', '<p>This Tour will show you how you can create Contacts in Joomla!</p>', 0, '[\"*\"]', 'administrator/index.php?option=com_contact&view=contacts', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0, NULL, 0, 1),
(8, 0, 'How to create News Feeds?', '<p>This Tour will show you how you can create News Feeds in Joomla!</p>', 0, '[\"*\"]', 'administrator/index.php?option=com_newsfeeds&view=newsfeeds', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0, NULL, 0, 1),
(9, 0, 'How to create Smart Search?', '<p>This Tour will show you how you can create Smart Search in Joomla!</p>', 0, '[\"*\"]', 'administrator/index.php?option=com_finder&view=filters', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0, NULL, 0, 1),
